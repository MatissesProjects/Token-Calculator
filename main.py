...
# --- 1. THE EXPANDED FALLBACK CATALOG ---
# Extracted from comprehensive pricing data
BASE_CATALOG = {
    # ------------------ AMAZON ------------------
    ...
    # ------------------ GOOGLE ------------------
    "gemini-1.5-flash-8b": {"name": "Gemini 1.5 Flash-8B ≤128k", "provider": "Google", "input_price": 0.0375, "output_price": 0.15, "speed_tps": 120, "cache_discount": 1.0},
    "gemini-1.5-flash-8b-128k": {"name": "Gemini 1.5 Flash-8B >128k", "provider": "Google", "input_price": 0.075, "output_price": 0.30, "speed_tps": 120, "cache_discount": 1.0},
    "gemini-1.5-flash": {"name": "Gemini 1.5 Flash ≤128k", "provider": "Google", "input_price": 0.075, "output_price": 0.30, "speed_tps": 120, "cache_discount": 1.0},
    "gemini-1.5-flash-128k": {"name": "Gemini 1.5 Flash >128k", "provider": "Google", "input_price": 0.15, "output_price": 0.60, "speed_tps": 120, "cache_discount": 1.0},
    "gemini-1.5-pro": {"name": "Gemini 1.5 Pro ≤128k", "provider": "Google", "input_price": 1.25, "output_price": 5.00, "speed_tps": 40, "cache_discount": 1.0},
    "gemini-1.5-pro-128k": {"name": "Gemini 1.5 Pro >128k", "provider": "Google", "input_price": 2.50, "output_price": 10.00, "speed_tps": 40, "cache_discount": 1.0},
    ...
    "gemini-2.5-pro-preview-03-25": {"name": "Gemini 2.5 Pro Preview ≤200k", "provider": "Google", "input_price": 1.25, "output_price": 10.00, "speed_tps": 40, "cache_discount": 1.0},
    "gemini-2.5-pro-preview-03-25-200k": {"name": "Gemini 2.5 Pro Preview >200k", "provider": "Google", "input_price": 2.50, "output_price": 15.00, "speed_tps": 40, "cache_discount": 1.0},
    "gemini-2.5-pro": {"name": "Gemini 2.5 Pro ≤200k", "provider": "Google", "input_price": 1.25, "output_price": 10.00, "speed_tps": 40, "cache_discount": 0.10},
    "gemini-2.5-pro-200k": {"name": "Gemini 2.5 Pro >200k", "provider": "Google", "input_price": 2.50, "output_price": 15.00, "speed_tps": 40, "cache_discount": 0.10},
    ...
    "gemini-3-pro-preview": {"name": "Gemini 3 Pro ≤200k", "provider": "Google", "input_price": 2.00, "output_price": 12.00, "speed_tps": 40, "cache_discount": 1.0},
    "gemini-3-pro-preview-200k": {"name": "Gemini 3 Pro >200k", "provider": "Google", "input_price": 4.00, "output_price": 18.00, "speed_tps": 40, "cache_discount": 1.0},
    "gemini-3-1-pro-preview": {"name": "Gemini 3.1 Pro ≤200k", "provider": "Google", "input_price": 2.00, "output_price": 12.00, "speed_tps": 40, "cache_discount": 1.0},
    "gemini-3-1-pro-preview-200k": {"name": "Gemini 3.1 Pro >200k", "provider": "Google", "input_price": 4.00, "output_price": 18.00, "speed_tps": 40, "cache_discount": 1.0},
    ...
    "gpt-5.4": {"name": "GPT-5.4 ≤272k", "provider": "OpenAI", "input_price": 2.50, "output_price": 15.00, "speed_tps": 60, "cache_discount": 0.10},
    "gpt-5.4-272k": {"name": "GPT-5.4 >272k", "provider": "OpenAI", "input_price": 5.00, "output_price": 22.50, "speed_tps": 60, "cache_discount": 0.10},
    "gpt-5.4-pro": {"name": "GPT-5.4 Pro ≤272k", "provider": "OpenAI", "input_price": 30.00, "output_price": 180.00, "speed_tps": 40, "cache_discount": 1.0},
    "gpt-5.4-pro-272k": {"name": "GPT-5.4 Pro >272k", "provider": "OpenAI", "input_price": 60.00, "output_price": 270.00, "speed_tps": 40, "cache_discount": 1.0},
    ...
    "claude-sonnet-4.5": {"name": "Claude Sonnet 4 and 4.5 ≤200k", "provider": "Anthropic", "input_price": 3.00, "output_price": 15.00, "speed_tps": 80, "cache_discount": 1.0},
    "claude-sonnet-4.5-200k": {"name": "Claude Sonnet 4.5 >200k", "provider": "Anthropic", "input_price": 6.00, "output_price": 22.50, "speed_tps": 80, "cache_discount": 1.0},
    ...
    # ------------------ XAI (GROK) ------------------
    "grok-4-fast": {"name": "Grok 4 Fast ≤128k", "provider": "xAI", "input_price": 0.20, "output_price": 0.50, "speed_tps": 120, "cache_discount": 0.25},
    "grok-4-fast-reasoning": {"name": "Grok 4 Fast Reasoning ≤128k", "provider": "xAI", "input_price": 0.20, "output_price": 0.50, "speed_tps": 40, "cache_discount": 0.25},
    ...
    "grok-4-fast-128k": {"name": "Grok 4 Fast >128k", "provider": "xAI", "input_price": 0.40, "output_price": 1.00, "speed_tps": 120, "cache_discount": 0.125},
    "grok-4-fast-reasoning-128k": {"name": "Grok 4 Fast Reasoning >128k", "provider": "xAI", "input_price": 0.40, "output_price": 1.00, "speed_tps": 40, "cache_discount": 0.125},
    "grok-3": {"name": "Grok 3", "provider": "xAI", "input_price": 3.00, "output_price": 15.00, "speed_tps": 60, "cache_discount": 0.25},
    "grok-4": {"name": "Grok 4 ≤128k", "provider": "xAI", "input_price": 3.00, "output_price": 15.00, "speed_tps": 60, "cache_discount": 0.25},
    "grok-4-128k": {"name": "Grok 4 >128k", "provider": "xAI", "input_price": 6.00, "output_price": 30.00, "speed_tps": 60, "cache_discount": 0.125},
